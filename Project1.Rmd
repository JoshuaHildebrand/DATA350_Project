...
```{r}
# Race1 distribution
ggplot(nhanes_clean, aes(x = Poverty, y = BMI, color = Race1)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = "lm", se = TRUE) +
  facet_wrap(~ Race1) +
  labs(
    title = "Relationship Between Poverty Ratio and BMI Across Race1",
    x = "Poverty Ratio",
...
ggplot(nhanes_clean, aes(x = Poverty, y = BMI, color = Race3)) +
  ...
  facet_wrap(~ Race3) +
  labs(
    title = "Relationship Between Poverty Ratio and BMI Across Race3",
    x = "Poverty Ratio",
    y = "Body Mass Index (BMI)"
  ) 
```
...
```{r}
# Race1 distribution
ggplot(nhanes_clean, aes(x = Race1, y = TotChol, color = Race1)) +
  geom_jitter(alpha = 0.3, width = 0.2) +
  geom_boxplot(alpha = 0.4, outlier.shape = NA) +
  labs(
    title = "Total Cholesterol by Race1 and Poverty Ratio Groups",
    x = "Race1 Category",
...
ggplot(nhanes_clean, aes(x = Race3, y = TotChol, color = Race3)) +
  ...
  geom_boxplot(alpha = 0.4, outlier.shape = NA) +
  labs(
    title = "Total Cholesterol by Race3 and Poverty Ratio Groups",
    x = "Race3 Category",
    y = "Total Cholesterol (mmol/L)"
  )
```
